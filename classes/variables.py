...
CAMERA_ELEMENT = """<Item class="Camera" referent="{reff}"><Properties><BinaryString name="AttributesSerialize"></BinaryString><CoordinateFrame name="CFrame"><X>{xx}</X><Y>{yy}</Y><Z>{zz}</Z><R00>0.999988317</R00><R01>1.4234256e-05</R01><R02>0.00485229073</R02><R10>-0</R10><R11>0.999995768</R11><R12>-0.00293349964</R12><R20>-0.00485231215</R20><R21>0.00293346541</R21><R22>0.999983907</R22></CoordinateFrame><Ref name="CameraSubject">null</Ref><token name="CameraType">0</token><float name="FieldOfView">70</float><token name="FieldOfViewMode">0</token><CoordinateFrame name="Focus"><X>{xx}</X><Y>{yy}</Y><Z>{zz}</Z><R00>1</R00><R01>0</R01><R02>0</R02><R10>0</R10><R11>1</R11><R12>0</R12><R20>0</R20><R21>0</R21><R22>1</R22></CoordinateFrame><bool name="HeadLocked">true</bool><float name="HeadScale">1</float><string name="Name">ThumbnailCamera</string><int64 name="SourceAssetId">-1</int64><BinaryString name="Tags"></BinaryString></Properties></Item>""".format(reff = get_random_string(32), xx=BASE_POSITION[0]+1163, yy=BASE_POSITION[1]-1163, zz=BASE_POSITION[2]+1186)
